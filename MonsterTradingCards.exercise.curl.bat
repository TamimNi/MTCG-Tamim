...
echo 22) Unique
echo kienboec
curl -X GET http://localhost:10001/newcards --header "Authorization: Basic kienboec-mtcgToken"
echo.
echo altenhof
curl -X GET http://localhost:10001/newcards --header "Authorization: Basic altenhof-mtcgToken"
echo.
echo kienboec
curl -X GET http://localhost:10001/newcards --header "Authorization: Basic kienboec-mtcgToken"
echo.
